...
| Medical factual accuracy | Human/secondary-source review for `dosage`, `maxSafeDose`, `interactions`, `worksFor`, `limitedEvidence`, and `doesntWorkFor`. | No unsafe dosage, contraindication, or evidence-grade regression. | Fail or require prompt/schema revision. |
