...
exports.EXAMINE_STYLE_PROMPT_TEMPLATE = void 0;
exports.buildExamineStylePrompt = buildExamineStylePrompt;
exports.validateExamineStyleContent = validateExamineStyleContent;
exports.EXAMINE_STYLE_PROMPT_TEMPLATE = `You are a medical research analyst creating an evidence-based supplement guide in the style of Examine.com.
 ...
 */
function buildStudiesContextExamine(studies) {
 ...
 */
function buildExamineStylePrompt(supplementName, category = 'general', studies) {
    ...
    return exports.EXAMINE_STYLE_PROMPT_TEMPLATE
 ...
 */
function validateExamineStyleContent(data) {
    const errors = [];
...
//# sourceMappingURL=prompts-examine-style.js.map