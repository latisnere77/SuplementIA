...
function isSpanishTerm(term: string): boolean {
  ...
  // Spanish keywords and common words
  const spanishKeywords = [
    'vitamina', 'acido', 'ácido', 'extracto',
    'romero', 'crecimiento', 'cabello', 'pelo', 'caida',
    'dolor', 'salud', 'energia', 'energía', 'mejorar',
    'reducir', 'aumento', 'pérdida', 'perdida',
    'para', 'con', 'sin', 'contra', 'contra',
  ];
