          ...
          json: {
            ...
            properties: {
              ...
              worksFor: {
                type: 'array',
                description:
                  'Conditions/benefits with strong evidence, ordered by evidence grade (A first, then B, C, D). Maximum 5-6 items, prioritize highest evidence.',
                items: {
                  type: 'object',
                  properties: {
                    condition: {
              ...
              doesntWorkFor: {
                type: 'array',
                description:
                  'Conditions where evidence is insufficient or negative. Maximum 5-6 items.',
                items: {
                  type: 'object',
                  properties: {
                    condition: {
              ...
              limitedEvidence: {
                type: 'array',
                description:
                  'Conditions with promising but insufficient preliminary evidence. Maximum 3-4 items.',
                items: {
                  type: 'object',
                  properties: {
                    condition: {
