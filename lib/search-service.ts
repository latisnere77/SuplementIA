...
const LOCAL_SUPPLEMENT_DESCRIPTIONS: Record<string, string> = {
  ...
  psyllium: 'Psyllium is a soluble fiber from Plantago ovata husk studied in human trials for bowel regularity, LDL cholesterol reduction, and post-meal glucose response.',
  'psyllium fiber': 'Psyllium is a soluble fiber from Plantago ovata husk studied in human trials for bowel regularity, LDL cholesterol reduction, and post-meal glucose response.',
  'psyllium husk': 'Psyllium is a soluble fiber from Plantago ovata husk studied in human trials for bowel regularity, LDL cholesterol reduction, and post-meal glucose response.',
