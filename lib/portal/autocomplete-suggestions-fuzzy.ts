...
const CROSS_LANGUAGE_TOKENS: Record<string, string[]> = {
  ...
  'magnesio': ['magnesium'],
  'berberina': ['berberine'],
  'melena': ['lion', 'mane', 'hericium'],
  'leon': ['lion', 'mane', 'hericium'],
  'león': ['lion', 'mane', 'hericium'],
  'cardo': ['milk', 'thistle', 'silybum'],
  'mariano': ['milk', 'thistle', 'silybum'],
  'curcuma': ['turmeric'],
  'cúrcuma': ['turmeric'],
  'coenzima': ['coenzyme', 'coq10'],
  'sabila': ['aloe'],
  'sábila': ['aloe'],
  'verde': ['green', 'tea'],
  'hierro': ['iron'],
  ...
  'magnesium': ['magnesio'],
  'berberine': ['berberina'],
  'lion': ['melena', 'leon', 'león'],
  'mane': ['melena', 'leon', 'león'],
  'hericium': ['melena', 'leon', 'león'],
  'milk': ['cardo', 'mariano'],
  'thistle': ['cardo', 'mariano'],
  'silybum': ['cardo', 'mariano'],
  'turmeric': ['curcuma', 'cúrcuma'],
  'coenzyme': ['coenzima'],
  'coq10': ['coenzima'],
  'aloe': ['sabila', 'sábila'],
  'green': ['verde'],
